...
public class CameraControl : MonoBehaviour {
	...
	//camera moves when moving mouse while holding down Mouse 3 (scroll button, middle click)
	void MoveCamera(){
		...
		if (Input.GetMouseButton (2)) {
			...
			updatedCameraPosition.x -= panSpeed * Input.GetAxis ("Mouse X");
			updatedCameraPosition.y -= panSpeed * Input.GetAxis ("Mouse Y");
		}
